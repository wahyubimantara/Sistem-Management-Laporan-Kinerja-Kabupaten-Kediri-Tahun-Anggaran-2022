        ...
        <div class="row" style="float:right; display: inline; break-inside: avoid">
            <div class="card" style="width: 18rem; border:none; ">
                <div class="card-body" style="color: black;">
                    <h6 style="text-align: center;">Kediri,&emsp;&emsp;<?php echo strftime('%B %Y', $hariIni->getTimestamp()) ?></h6>
                    <h6 style="text-align: center;"></h6>
                    <br> <br> <br> <br>
                    <h6 style="text-align: center; margin-bottom: 0rem; "><strong></strong></h6>
                    <hr style="margin-top: 0rem; margin-bottom: 0rem; width:85%;border-top: 1px solid rgb(12 12 12 / 67%);">
                    <h6 style="text-align: left; margin-top: 0rem; ">&emsp;&emsp;NIP.&nbsp;</h6>
