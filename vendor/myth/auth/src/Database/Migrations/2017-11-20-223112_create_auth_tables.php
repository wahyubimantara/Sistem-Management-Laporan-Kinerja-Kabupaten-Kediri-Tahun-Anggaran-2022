...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'kd_urusan'        => ['type' => 'int', 'constraint' => 5, 'null' => 0, 'default' => 1],
            'kd_bidang'        => ['type' => 'int', 'constraint' => 5, 'null' => 0, 'default' => 1],
            'kd_unit'          => ['type' => 'int', 'constraint' => 5, 'null' => 0, 'default' => 1],
            'kd_sub'           => ['type' => 'varchar', 'constraint' => 20, 'null' => 0, 'default' => 1],
